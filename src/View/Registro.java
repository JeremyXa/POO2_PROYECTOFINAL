...
public class Registro extends javax.swing.JFrame {
 ...
 private static final java.util.logging.Logger logger =
    ...
    // Referencia al menú que abrió este flujo
    private final Menu menuParent;

    /**
     * Constructor principal: se usa desde loginRegistro
     */
    public Registro(AdraController controller, Menu menuParent) {
    ...
    /**
     * Constructor compatibilidad (sin menú)
     */
    ...
    /**
     * Solo para previsualizar en NetBeans
     */
    public Registro() {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         if (controller == null) {
            JOptionPane.showMessageDialog(this, "Controller no configurado.", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        try {
            ResultadoOperacion resultado = controller.registrarDonacion(codigo, descripcion, fecha, cantidad, donante);
            ...
            JOptionPane.showMessageDialog(this, "Ocurrió un error al registrar la donación.", "Error", JOptionPane.ERROR_MESSAGE);
        }
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        limpiarFormulario();
        JOptionPane.showMessageDialog(this, "Formulario listo para una nueva donación.", "Información", JOptionPane.INFORMATION_MESSAGE);
